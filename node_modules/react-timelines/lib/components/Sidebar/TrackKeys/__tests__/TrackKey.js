...
describe('<TrackKey />', function () {
  describe('side component', function () {
    var sideComponent = _react2.default.createElement(
      'span',
    ...
    it('renders the side component if "sideComponent" exists', function () {
      var track = { title: 'test', isOpen: true, sideComponent: sideComponent };
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_TrackKey2.default, { track: track, clickTrackButton: jest.fn() }));
  ...
  describe('link button', function () {
    ...
    it('does not render when "sideComponent" is present', function () {
      var track = {
        title: 'test', isOpen: true, hasButton: true, sideComponent: _react2.default.createElement(
          'span',
          null,
          'Component'
        )
    ...
    it('does not render when "clickTrackButton" does not exist', function () {
      var track = { title: 'test', isOpen: true, hasButton: true };
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_TrackKey2.default, { track: track }));
      expect(getButton(wrapper).exists()).toBe(false);
    });
    ...
    it('calls "clickTrackButton" with the track when clicked', function () {
      ...
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_TrackKey2.default, { track: track, clickTrackButton: clickTrackButton }));
